...
This is an [Ansible](https://www.ansible.com/) role which installs [Lidarr](https://www.lidarr.media/), a music collection manager, to run as a [Docker](https://www.docker.com/) container wrapped in a systemd service.
